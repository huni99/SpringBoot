...
public class FileDownView extends AbstractView {
	...
	protected void renderMergedOutputModel(Map<String, Object> model, HttpServletRequest request,
		...
		//header 설정
		response.setHeader("Content-Disposition","attachment;filename=\""+fileName+"\""); //첨부파일이면서 파일이름은 fileName이다
		response.setHeader("Content-Transfer-Encoding", "binary");//파일이 이진파일이다
